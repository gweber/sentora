...
async def upsert_control_config(
    ...
    if config.severity_override:
        doc["severity_override"] = config.severity_override.value
    if config.parameters_override:
        doc["parameters_override"] = config.parameters_override
    if config.scope_tags_override is not None:
        doc["scope_tags_override"] = config.scope_tags_override
    if config.scope_groups_override is not None:
        doc["scope_groups_override"] = config.scope_groups_override
