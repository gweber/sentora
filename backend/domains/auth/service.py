...
def verify_token(token: str) -> TokenPayload:
    ...
    # Enforce aud/iss claims — defense-in-depth against forged tokens
    if payload.get("aud") != "sentora-api":
        raise ValueError("Invalid or missing token audience")
    if payload.get("iss") != "sentora":
        raise ValueError("Invalid or missing token issuer")
