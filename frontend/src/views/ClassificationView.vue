...
const verdictStyle: Record<string, string> = {
  ...
  misclassified:  'bg-amber-100 text-amber-700',
  ...
  <div class="p-6 space-y-5">
    ...
    <div class="flex flex-wrap items-start gap-4">
      ...
      <div class="flex flex-col items-end gap-2 shrink-0">
        ...
        <span v-if="store.error" class="text-[11px] text-red-500 max-w-[240px] text-right">{{ store.error }}</span>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center gap-2">
      ...
      <div class="relative ml-auto">
        ...
        <input
          ...
          class="pl-8 pr-3 py-1.5 text-[12px] rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-300 w-44"
          ...
          >
            <td class="px-4 py-3">
              ...
              <span
                ...
                class="ml-1.5 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-red-100 text-red-600"
