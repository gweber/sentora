      ...
      <div class="rounded-xl shadow-sm p-6" style="background: var(--surface); border: 1px solid var(--border);">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <button
            ...
            class="w-full py-2 px-4 text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div class="mt-5 pt-4 text-center" style="border-top: 1px solid var(--border-light);">
          <button
            @click="toggleMode"
            class="text-sm text-indigo-500 hover:text-indigo-600 font-medium transition"
          >
