  ...
  <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        >
          <div class="flex items-center justify-between mb-2">
            ...
            <label class="relative inline-flex items-center cursor-pointer" @click.stop>
              ...
              >
              <div class="w-9 h-5 bg-gray-300 peer-checked:bg-indigo-600 rounded-full transition-colors after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:after:translate-x-4"></div>
            </label>
          </div>
    ...
    <section v-if="store.activeFramework" class="mb-8">
      <div class="flex items-center justify-between mb-4">
        ...
        <button
          class="px-3 py-1.5 bg-indigo-600 text-white rounded-lg text-sm hover:bg-indigo-700 transition-colors"
              ...
              <div class="flex-1">
                ...
                <div v-if="ctrl.scope_tags.length || ctrl.scope_groups.length" class="flex gap-1 mt-1">
                  ...
                  <span
                    ...
                    :key="group"
                    class="text-xs px-1.5 py-0.5 rounded"
                    style="background: var(--scope-group); color: white;"
                  >
                    {{ group }}
                  </span>
                </div>
