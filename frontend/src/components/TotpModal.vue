  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4" @click.self="emit('close')">
    <div class="rounded-xl shadow-xl w-full max-w-sm p-6" style="background: var(--surface); border: 1px solid var(--border);" role="dialog" aria-modal="true" :aria-label="mode === 'setup' ? 'Set up two-factor authentication' : 'Enter verification code'">
      ...
      <div class="text-center mb-5">
        <div class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-indigo-500/10 mb-3">
          <svg class="w-5 h-5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
      ...
      <div class="flex gap-3">
        ...
        <button
          ...
          class="flex-1 py-2 px-4 text-sm font-medium text-white bg-indigo-500 hover:bg-indigo-600 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
